        ...
        {result && phase === 'done' && (
          <motion.div initial={{scale:0.8,opacity:0}} animate={{scale:1,opacity:1}} 
            ...
            className="p-8 bg-white/70 backdrop-blur-3xl rounded-[2.5rem] text-center shadow-2xl border border-white/90">
             <h3 className="text-4xl sm:text-5xl font-black tracking-tighter drop-shadow-sm mb-2" style={{color: currentLineData.color}}>{result}역 <span className="text-2xl sm:text-3xl text-slate-400 font-bold leading-normal">당첨!</span></h3>
